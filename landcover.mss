...
#text-line {
  ...
  [feature = 'natural_valley'][zoom >= 10] {
    ...
    text-name: "[name]";
      ...
      [zoom >= 14] { text-size: 12; text-character-spacing: 3; } // this allows to also show small valleys within mountains
	    [zoom >= 15] { text-size: 16; }
	    [zoom >= 16] { text-size: 18; text-character-spacing: 4; }
	     // long valleys and glaciers > 20km
	    #text-line {
		    [line_length>20000]             { text-size: 25; text-character-spacing: 10; text-opacity: 0.6; }
		    [zoom <= 14][line_length>20000] { text-size: 20; text-character-spacing: 10; text-opacity: 0.5; }
		    [zoom <= 13][line_length>20000] { text-size: 18; text-character-spacing: 10; text-opacity: 0.6; }
		    [zoom <= 12][line_length>20000] { text-size: 15; text-character-spacing: 10; text-opacity: 0.6; }
		    [zoom <= 10][line_length>20000] { text-size: 15; text-character-spacing: 1; }
	    }
    }
