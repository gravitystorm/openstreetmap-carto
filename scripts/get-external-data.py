...
def main():
    ...
    parser.add_argument("-l", "--local", action="store_true",
                        help="Expect files to exist locally in the data downloa directory. With this option, external downloads will not attempt to be retrieved from the internet. Instead they will simply be imported into the database.")
