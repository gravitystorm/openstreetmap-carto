...
assert(deepcompare(table_contents.planet_osm_admin[1], {admin_level = 2, multiple_relations = true, way = {create = "line" } }), "row 1")
assert(deepcompare(table_contents.planet_osm_admin[2], {admin_level = 2, multiple_relations = true, way = {create = "line" } }), "row 2")
assert(deepcompare(table_contents.planet_osm_admin[3], {admin_level = 2, multiple_relations = false, way = {create = "line" } }), "row 3")
assert(deepcompare(table_contents.planet_osm_admin[4], {admin_level = 4, multiple_relations = false, way = {create = "line" } }), "row 4")
assert(deepcompare(table_contents.planet_osm_admin[5], {admin_level = 2, multiple_relations = false, way = {create = "line" } }), "row 5")
assert(deepcompare(table_contents.planet_osm_admin[6], {admin_level = 2, multiple_relations = false, way = {create = "line" } }), "row 6")
assert(deepcompare(table_contents.planet_osm_admin[7], {admin_level = 2, multiple_relations = true, way = {create = "line" } }), "row 7")
assert(deepcompare(table_contents.planet_osm_admin[8], {admin_level = 2, multiple_relations = true, way = {create = "line" } }), "row 8")
assert(deepcompare(table_contents.planet_osm_admin[9], {admin_level = 2, multiple_relations = false, way = {create = "line" } }), "row 9")
