...
local roads_info = {
    highway = {
        ...
        motorway_link   = {z = 38, roads = true},
        trunk           = {z = 37, roads = true},
        trunk_link      = {z = 37, roads = true},
        primary         = {z = 36, roads = true},
        primary_link    = {z = 36, roads = true},
        secondary       = {z = 35, roads = true},
        secondary_link  = {z = 35, roads = true},
        tertiary        = {z = 34, roads = false},
        tertiary_link   = {z = 34, roads = false},
        ...
        construction    = {z = 1,  roads = false}
    },
    railway = {
        rail            = {z = 44, roads = true},
        subway          = {z = 42, roads = true},
        narrow_gauge    = {z = 42, roads = true},
        light_rail      = {z = 42, roads = true},
        funicular       = {z = 42, roads = true},
        preserved       = {z = 42, roads = false},
        monorail        = {z = 42, roads = false},
        miniature       = {z = 42, roads = false},
        turntable       = {z = 42, roads = false},
        tram            = {z = 41, roads = false},
        disused         = {z = 40, roads = false},
        construction    = {z = 40, roads = false},
        platform        = {z = 9,  roads = false},
    },
    aeroway = {
        runway          = {z = 6,  roads = false},
        taxiway         = {z = 5,  roads = false},
    },
    boundary = {
