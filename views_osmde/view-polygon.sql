DROP VIEW IF EXISTS view_osmde_carto_polygon;
CREATE VIEW view_osmde_carto_polygon AS
SELECT
osm_id,
...
get_latin_name(tags->'name',tags->'name:de',tags->'int_name',tags->'name:en', way) as latin_name,
tags as "tags"
FROM planet_osm_polygon;

GRANT select ON view_osmde_carto_polygon TO public;
