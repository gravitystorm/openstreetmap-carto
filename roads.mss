...
#tunnels[zoom >= 10] {
  ...
  // z_order 330 (white), 340 (and corresponding link roads)
    [feature = 'highway_residential'],
    [feature = 'highway_unclassified'] {
  ...
  // z_order 360 (and corresponding link roads)
    [feature = 'highway_primary'] {
      [zoom >= 8][link != 'yes'],
      [zoom >= 10] {
  ...
  // z_order 370 (and corresponding link roads)
    [feature = 'highway_trunk'] {
      [zoom >= 6][link != 'yes'],
      [zoom >= 10] {
  ...
  // z_order 380 (and corresponding link roads)
    [feature = 'highway_motorway'] {
      [zoom >= 6][link != 'yes'],
      [zoom >= 10] {
